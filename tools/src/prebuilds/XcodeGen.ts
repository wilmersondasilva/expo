  ...
  return {
    ...
    settings: {
      base: {
        ...
        SWIFT_IMPORT_PATHS: `$(inherited) /var/folders/qp/ympy822d7j97b4q14r7lx30w0000gn/T/Expo/DerivedData/Build/Products/Release-iphoneos/ExpoModulesCore.framework/Modules`,
